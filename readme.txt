...
1. for bruteforce verification in C, run "gcc c-bruteforce.c && ./a.out"

2. for bruteforce verification in python, run "python python-bruteforce.py"

3. for a sophisticated verification in python using SMT (SAT modulo theories), 
